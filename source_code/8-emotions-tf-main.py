...
# import dataset
df = pd.read_csv("All-emotions.csv" , index_col=False)
...
size_output = 8   # 8 emotions, hence 8 output layer neurons
size_hidden1 = 64 # hidden layer 1
size_hidden2 = 32 # hidden layer 2
size_hidden3 = 16 # hidden layer 3
...
with tf.Session() as sess:
    ...
    saved_loc = saver.save(sess,"saved_models/8_emotion_model.ckpt")
